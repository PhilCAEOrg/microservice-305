 ...
 * 680 - Test Class
 *
 * This class provides a basic testing framework for the microservice 680. It was
...
public class testTest {
  ...
  private static final ServiceNameVersion testTemplateService = new ServiceNameVersion(test.class.getCanonicalName(),"0.1");

  private static final String mainPath = "test";
  ...
  public void testtest() {
    ...
    try {
      ...
      ClientResponse result = c.sendRequest("GET", mainPath + "/test", test.toJSONString(),
